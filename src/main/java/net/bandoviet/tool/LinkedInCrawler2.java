...
@Service
public class LinkedInCrawler2 {
  private static final Logger LOGGER = LoggerFactory.getLogger(LinkedInCrawler2.class);
  ...
  public void getDataFromLinkedin() {
    ...
    //linksInProgress.add("https://fr.linkedin.com/pub/trong-hieu-ha/24/450/183");
  ...
  private List initSeeds() {
    ...
    for (int k = 0; k < VietnameseWords.VOCABULARY.split(" ").length; k++){
      ...
      String url = "https://www.linkedin.com/pub/dir/?first="+VietnameseWords.VOCABULARY.split(" ")[k]+"&last=" + VietnameseWords.surnames[i] + "&search=Search&searchType=fps";
      Document doc;
      try {
    ...
    for (int k = 0; k < VietnameseWords.AmericanNames.length; k++){
      ...
      String url = "https://www.linkedin.com/pub/dir/?first="+VietnameseWords.AmericanNames[k]+"&last=" + VietnameseWords.surnames[i] + "&search=Search&searchType=fps";
      Document doc;
      try {
        System.out.println("Dang xu ly: " + url);
        doc = Jsoup.connect(url)
