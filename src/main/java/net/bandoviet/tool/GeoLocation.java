 ...
 * <a href="http://JanMatuschek.de/LatitudeLongitudeBoundingCoordinates#Java"> http://JanMatuschek.
 * de/LatitudeLongitudeBoundingCoordinates#Java</a>.
 * </p>
 *
...
public class GeoLocation {
  ...
  public String toString() {
    return "(" + degLat + "\u00B0, " + degLon + "\u00B0) = (" + radLat + " rad, " + radLon
        + " rad)";
  }
   ...
   * 
   * @param radius
   *          the radius of the sphere, e.g. the average radius for a spherical approximation of the
   *          figure of the Earth is approximately 6371.01 kilometers.
  ...
  public double distanceTo(GeoLocation location, double radius) {
    return Math
        .acos(Math.sin(radLat) * Math.sin(location.radLat)
            + Math.cos(radLat) * Math.cos(location.radLat) * Math.cos(radLon - location.radLon))
        * radius;
  }
   ...
   * <a href="http://JanMatuschek.de/LatitudeLongitudeBoundingCoordinates"> http://JanMatuschek.de/
   * LatitudeLongitudeBoundingCoordinates</a>.
   * </p>
   * 
   * @param distance
   *          the distance from the point represented by this GeoLocation instance. Must me measured
   *          in the same unit as the radius argument.
   * @param radius
   *          the radius of the sphere, e.g. the average radius for a spherical approximation of the
   *          figure of the Earth is approximately 6371.01 kilometers.
   ...
   *         latitude of the first array element and smaller or equal to the latitude of the second
   *         array element.</li>
